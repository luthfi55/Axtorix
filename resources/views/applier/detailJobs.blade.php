        ...
        <div class="container">
          ...
          <div class="row mt-10">
            <div class="col-lg-8 col-md-12">
              <h3>{{$job->name}}</h3>
              <div class="mt-0 mb-15"><span class="card-time">3 mins ago</span></div>
            </div>
              ...
              <div class="job-overview">
                ...
                <div class="row">
                  <div class="col-md-6 d-flex">
                    <div class="sidebar-icon-item"><img src="/dashboard/assets/imgs/page/job-single/industry.svg" alt="jobBox"></div>
                  ...
                  <div class="col-md-6 d-flex mt-sm-15">
                    <div class="sidebar-icon-item"><img src="/dashboard/assets/imgs/page/job-single/job-level.svg" alt="jobBox"></div>
                ...
                <div class="row mt-25">
                  <div class="col-md-6 d-flex mt-sm-15">
                    <div class="sidebar-icon-item"><img src="/dashboard/assets/imgs/page/job-single/salary.svg" alt="jobBox"></div>
                  ...
                  <div class="col-md-6 d-flex">
                    <div class="sidebar-icon-item"><img src="/dashboard/assets/imgs/page/job-single/experience.svg" alt="jobBox"></div>
                ...
                <div class="row mt-25">
                  <div class="col-md-6 d-flex mt-sm-15">
                    <div class="sidebar-icon-item"><img src="/dashboard/assets/imgs/page/job-single/job-type.svg" alt="jobBox"></div>
                  ...
                  <div class="col-md-6 d-flex mt-sm-15">
                    <div class="sidebar-icon-item"><img src="/dashboard/assets/imgs/page/job-single/deadline.svg" alt="jobBox"></div>
                ...
                <div class="row mt-25">
                  <div class="col-md-6 d-flex mt-sm-15">
                    <div class="sidebar-icon-item"><img src="/dashboard/assets/imgs/page/job-single/updated.svg" alt="jobBox"></div>
                  ...
                  <div class="col-md-6 d-flex mt-sm-15">
                    <div class="sidebar-icon-item"><img src="/dashboard/assets/imgs/page/job-single/location.svg" alt="jobBox"></div>
              ...
              <div class="single-apply-jobs">
                <div class="row align-items-center">
                  ...
                  <div class="col-md-7 text-lg-end social-share">
                    <h6 class="color-text-paragraph-2 d-inline-block d-baseline mr-10">Share this</h6><a class="mr-5 d-inline-block d-middle" href="job-details.html#"><img alt="jobBox" src="/dashboard/assets/imgs/template/icons/share-fb.svg"></a><a class="mr-5 d-inline-block d-middle" href="job-details.html#"><img alt="jobBox" src="/dashboard/assets/imgs/template/icons/share-tw.svg"></a><a class="mr-5 d-inline-block d-middle" href="job-details.html#"><img alt="jobBox" src="/dashboard/assets/imgs/template/icons/share-red.svg"></a><a class="d-inline-block d-middle" href="job-details.html#"><img alt="jobBox" src="/dashboard/assets/imgs/template/icons/share-whatsapp.svg"></a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="sidebar-border">
                <div class="sidebar-heading">
                  <div class="avatar-sidebar">
                    ...
                    <div class="sidebar-info"><span class="sidebar-company">AliThemes</span><span class="card-location">New York, US</span><a class="link-underline mt-15" href="job-details.html#">02 Open Jobs</a></div>
                  </div>
                </div>
                <div class="sidebar-list-job">
                  ...
                  <ul class="ul-disc">
                    ...
                    <li>Email: <a href="../../../cdn-cgi/l/email-protection.html" class="__cf_email__" data-cfemail="ed8e8283998c8e99ada89b8c9f8cc38e8280">[email&#160;protected]</a></li>
                  </ul>
                </div>
              </div>
              <div class="sidebar-border">
                  ...
                  <ul>
                    <li>
                      <div class="card-list-4 wow animate__animated animate__fadeIn hover-up">
                        <div class="image"><a href="job-details.html"><img src="/dashboard/assets/imgs/brands/brand-1.png" alt="jobBox"></a></div>
                        <div class="info-text">
                    ...
                    <li>
                      <div class="card-list-4 wow animate__animated animate__fadeIn hover-up">
                        <div class="image"><a href="job-details.html"><img src="/dashboard/assets/imgs/brands/brand-2.png" alt="jobBox"></a></div>
                        <div class="info-text">
                    ...
                    <li>
                      <div class="card-list-4 wow animate__animated animate__fadeIn hover-up">
                        <div class="image"><a href="job-details.html"><img src="/dashboard/assets/imgs/brands/brand-3.png" alt="jobBox"></a></div>
                        <div class="info-text">
                    ...
                    <li>
                      <div class="card-list-4 wow animate__animated animate__fadeIn hover-up">
                        <div class="image"><a href="job-details.html"><img src="/dashboard/assets/imgs/brands/brand-4.png" alt="jobBox"></a></div>
                        <div class="info-text">
                    ...
                    <li>
                      <div class="card-list-4 wow animate__animated animate__fadeIn hover-up">
                        <div class="image"><a href="job-details.html"><img src="/dashboard/assets/imgs/brands/brand-5.png" alt="jobBox"></a></div>
                        <div class="info-text">
                    ...
                    <li>
                      <div class="card-list-4 wow animate__animated animate__fadeIn hover-up">
                        <div class="image"><a href="job-details.html"><img src="/dashboard/assets/imgs/brands/brand-6.png" alt="jobBox"></a></div>
                        <div class="info-text">
                    ...
                    <li>
                      <div class="card-list-4 wow animate__animated animate__fadeIn hover-up">
                        <div class="image"><a href="job-details.html"><img src="/dashboard/assets/imgs/brands/brand-7.png" alt="jobBox"></a></div>
                        <div class="info-text">
                    ...
                    <li>
                      <div class="card-list-4 wow animate__animated animate__fadeIn hover-up">
                        <div class="image"><a href="job-details.html"><img src="/dashboard/assets/imgs/brands/brand-8.png" alt="jobBox"></a></div>
                        <div class="info-text">
      ...
      <section class="section-box mt-50 mb-50">
        <div class="container">
          ...
          <div class="mt-50">
              ...
              <div class="swiper-container swiper-group-4 swiper">
                <div class="swiper-wrapper pb-10 pt-5">
                  <div class="swiper-slide">
                    <div class="card-grid-2 hover-up">
                      <div class="card-grid-2-image-left"><span class="flash"></span>
                        <div class="image-box"><img src="/dashboard/assets/imgs/brands/brand-6.png" alt="jobBox"></div>
                  ...
                  <div class="swiper-slide">
                    <div class="card-grid-2 hover-up">
                      <div class="card-grid-2-image-left"><span class="flash"></span>
                        <div class="image-box"><img src="/dashboard/assets/imgs/brands/brand-4.png" alt="jobBox"></div>
                  ...
                  <div class="swiper-slide">
                    <div class="card-grid-2 hover-up">
                      <div class="card-grid-2-image-left"><span class="flash"></span>
                        <div class="image-box"><img src="/dashboard/assets/imgs/brands/brand-8.png" alt="jobBox"></div>
            ...
            <div class="text-center"><a class="btn btn-grey" href="job-details.html#">Load more posts</a></div>
          </div>
        </div>
      </section>
      <section class="section-box mt-50 mb-20">
        <div class="container">
          <div class="box-newsletter">
            <div class="row">
              <div class="col-xl-3 col-12 text-center d-none d-xl-block"><img src="/dashboard/assets/imgs/template/newsletter-left.png" alt="joxBox"></div>
              ...
              <div class="col-xl-3 col-12 text-center d-none d-xl-block"><img src="/dashboard/assets/imgs/template/newsletter-right.png" alt="joxBox"></div>
            </div>
          </div>
        </div>
      </section>
