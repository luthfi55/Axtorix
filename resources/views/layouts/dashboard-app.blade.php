...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="/dashboard/assets/imgs/template/favicon.svg">
      ...
      <div class="container">
        <div class="main-header">
          <div class="header-left">
            <div class="header-logo"><a class="d-flex" href="index.html"><img alt="jobBox" src="/dashboard/assets/imgs/page/dashboard/logo.svg"></a></div><span class="btn btn-grey-small ml-10">Admin area</span>
          </div>
    ...
    <div class="nav"><a class="btn btn-expanded"></a>
        <nav class="nav-main-menu">
          <ul class="main-menu">
            ...
            <li> <a class="dashboard2" href="{{route('manager.manage-job')}}"><img src="/dashboard/assets/imgs/page/dashboard/jobs.svg" alt="jobBox"><span class="name">Manage Jobs</span></a>
            </li>
            <li> <a class="dashboard2" href="{{route('manager.post-job')}}"><img src="/dashboard/assets/imgs/page/dashboard/tasks.svg" alt="jobBox"><span class="name">Post Job</span></a>
            </li>            
          </ul>
        </nav>                
      </div>
